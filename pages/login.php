...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and execute the query to fetch the id and password
    ...
    if ($stmt->num_rows > 0) {
        $stmt->bind_result($user_id, $db_password); // Fetch both id and password
        $stmt->fetch();
        ...
        if (password_verify($password, $db_password)) {
            ...
            $_SESSION['user_id'] = $user_id; // Store the user_id (id) in session
